(function ($) {
  ...
  var chart = new ApexCharts(document.querySelector("#dayChart"), options);
  chart.render();

  // XRUN TRANSACTION HISTORY IN 14 DAYS
  ...
  var chart = new ApexCharts(document.querySelector("#dashChart"), options);
  chart.render();
